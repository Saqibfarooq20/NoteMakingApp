    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.flotingBtn.setOnClickListener {
            it.findNavController().navigate(
                R.id.action_homeFragment_to_newFragment
            )
        }
    }
...
//---------------------------------------------------------
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
     ...
     menu.clear()
        ...
        val mMenuSraerch = menu.findItem(R.id.search).actionView as SearchView
        mMenuSraerch.isSubmitButtonEnabled = false
        mMenuSraerch.setOnQueryTextListener(this)
    }
